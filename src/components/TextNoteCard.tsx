    ...
    <>
      ...
      >
        ...
        <div class="absolute right-4 top-0 flex flex-col justify-evenly z-20 py-8 gap-2">
          ...
          >
            <Icon name="share" size={20} style={{ color: colors.primaryText }} />
          </button>
          ...
          >
            <Icon name="pencil" size={20} style={{ color: colors.primaryText }} />
          </button>
          ...
          >
            <Icon name="trash" size={20} style={{ color: colors.primaryText }} />
          </button>
        </div>
